...
namespace commitQualityPractice_Playwright.Pages
{
    public class LoginPage
    {
        ...
        public ILocator _PasswordTextField => _page.Locator(selector: "#Password");
        ...
        public ILocator _EmployeeListLink => _page.Locator(selector: "text=Employee List");
       ...
       public async Task<bool> IsEmployeeDetailsTextVisible() => await _EmployeeDetailsText.IsVisibleAsync();
        public async Task ClickEmployeeListLink() => await _EmployeeListLink.ClickAsync();
